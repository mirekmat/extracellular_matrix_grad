...
classdef spring_angle_PG
   ...
   methods
      ...
      function obj = spring_angle_PG(A, size, mean, half_width, threshold, start, stop, step, fig1, fig2, S, B)
         if nargin > 0
            obj.SpringData = A;
            obj.Number = size;
            obj.Distr_Mean = mean;
            ...
            obj.Length = zeros(1,size,'double');
              for x = 1:1:obj.Number    
                 ...
                 h = obj.Distr_Mean - obj.Distr_Width + rand*obj.Distr_Width*2;
                 if (h > 3.14159/2)
                     h = (h - 3.14159/2)-3.14159/2;
                 end
                 obj.Angle(1,x) = h;
              end
              for Len = obj.Start_Length:obj.Step_Size:obj.Stop_Length             
                 for x = 1:1:obj.Number
                    ...
                    xlength = abs(cos(initial_angle))+ gsstiffness(initial_angle, obj.S_Constant, obj.B_Constant)*Disp;
      ...
      function H = Create_Hist(obj, index1)
           nbins = ((-3.14159/2)*(20/21)):((3.14159/2)*(2/21)):((3.14159/2)*(20/21));
           x = obj.Angle(index1,:);
      ...
      function plot_histogram_3d(obj)
          ...
          for Len = obj.Start_Length:obj.Step_Size:obj.Stop_Length             
             ...
             ybins = ((-3.14159/2)*(20/21)):((3.14159/2)*(2/21)):((3.14159/2)*(20/21));
             set(gca,'XTick', 1:41)
             set(gca,'YTick', 1:21)
